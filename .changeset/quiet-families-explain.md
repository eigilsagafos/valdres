...
the fix ("structured family arguments require a valid options.encodeKey"),
and zero-argument, non-State-returning, and loosely typed factories get their
own messages. Valid calls infer exactly as before.
