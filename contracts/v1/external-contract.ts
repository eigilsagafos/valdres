...
> = {
    ...
    "callback.external-subscribe": {
        ...
        errorRule:
            "Forbidden same-domain work throws CallbackCapabilityError. A throw rolls back provisional admission; a missing, non-function, or thenable cleanup throws InvalidExternalCleanupError. Runtime delivery limits are owned outside this callback boundary. Direct InvalidExternalCleanupError has frozen phase admitting, source external-startup, and committed equal to publication state at failure. Arbitrary setup throws and setup/cleanup aggregation use ExternalSourceOperationError; every failure occurrence is retained without deduplication by error identity.",
    },
