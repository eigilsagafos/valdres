...
|:----------|-----------:|-----------:|
| atom(1) | 🟢 9.5x faster | 🟢 1.7x faster |
| store.get(atom) | 🟢 27.4x faster | 🟢 9.9x faster |
| set(atom, value) | 🟢 13.8x faster | 🟢 3.3x faster |
| set(atom, curr => curr+1) | 🟢 16.1x faster | 🟢 5.5x faster |
| set(atom) with 10 subs | 🟢 14.6x faster | 🟢 3.9x faster |
| atom lifecycle (create+100get+100set) | 🟢 17.1x faster | 🟢 4.6x faster |
| set 1000 atoms | 🟢 11.2x faster | 🟢 5.5x faster |
| get 1000 atoms | 🟢 43.9x faster | 🟢 14.3x faster |
...
| set + read 10 selectors | 🟢 3.4x faster | 🟢 2.0x faster |
...
| Benchmark | JSC (Safari) | V8 (Chrome) |
|:----------|-----------:|-----------:|
| txn: 10 atoms × 10 selectors, set + read | 🟢 4.3x faster | 🟢 2.3x faster |
...
| txn: cross-atom 1000 selectors, with subs | 🟢 12.1x faster | 🟢 9.2x faster |

#### Families

| Benchmark | JSC (Safari) | V8 (Chrome) |
|:----------|-----------:|-----------:|
| atomFamily(id) cache hit | 🔴 2.6x slower | 🔴 3.3x slower |
...
| createStore | 🟢 22.9x faster | 🟢 3.3x faster |
