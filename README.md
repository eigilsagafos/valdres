...
|:----------|-----------:|-----------:|
| atom(1) | 🟢 19.8x faster | 🟢 2.1x faster |
| store.get(atom) | 🟢 12.8x faster | 🟢 13.5x faster |
| set(atom, value) | 🟢 12.7x faster | 🟢 4.3x faster |
| set(atom, curr => curr+1) | 🟢 15.1x faster | 🟢 4.7x faster |
| set(atom) with 10 subs | 🟢 19.1x faster | 🟢 5.4x faster |
| atom lifecycle (create+100get+100set) | 🟢 17.9x faster | 🟢 4.6x faster |
| set 1000 atoms | 🟢 15.7x faster | 🟢 5.0x faster |
| get 1000 atoms | 🟢 55.0x faster | 🟢 15.0x faster |

#### Selectors

| Benchmark | JSC (Safari) | V8 (Chrome) |
|:----------|-----------:|-----------:|
| selector(fn) | 🟢 13.7x faster | 🟢 1.1x faster |
...
| Benchmark | JSC (Safari) | V8 (Chrome) |
|:----------|-----------:|-----------:|
| txn: 10 atoms × 10 selectors, set + read | 🟢 5.2x faster | 🟢 1.8x faster |
...
| txn: cross-atom 1000 selectors, with subs | 🟢 17.4x faster | 🟢 12.5x faster |

#### Families

| Benchmark | JSC (Safari) | V8 (Chrome) |
|:----------|-----------:|-----------:|
| atomFamily(id) cache hit | 🔴 4.5x slower | 🔴 4.1x slower |
...
| createStore | 🟢 10.5x faster | 🟢 8.1x faster |
