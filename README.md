...
|:----------|-----------:|-----------:|
| atom(1) | 🟢 22.7x faster | 🟢 1.8x faster |
| store.get(atom) | 🟢 9.5x faster | 🟢 12.6x faster |
| set(atom, value) | 🟢 11.5x faster | 🟢 4.4x faster |
| set(atom, curr => curr+1) | 🟢 15.2x faster | 🟢 5.3x faster |
| set(atom) with 10 subs | 🟢 19.0x faster | 🟢 5.8x faster |
| atom lifecycle (create+100get+100set) | 🟢 18.2x faster | 🟢 4.6x faster |
| set 1000 atoms | 🟢 15.9x faster | 🟢 4.6x faster |
| get 1000 atoms | 🟢 81.6x faster | 🟢 15.0x faster |
...
| set + read through 5 chained selectors | 🟢 2.3x faster | 🟢 2.1x faster |

#### Transactions

| Benchmark | JSC (Safari) | V8 (Chrome) |
|:----------|-----------:|-----------:|
| txn: 10 atoms × 10 selectors, set + read | 🟢 3.7x faster | 🟢 1.9x faster |
| txn: 10 atoms × 10 selectors, with subs | 🟢 5.7x faster | 🟢 3.3x faster |
...
| txn: cross-atom 1000 selectors, with subs | 🟢 22.4x faster | 🟢 13.2x faster |

#### Families

| Benchmark | JSC (Safari) | V8 (Chrome) |
|:----------|-----------:|-----------:|
| atomFamily(id) cache hit | 🔴 4.8x slower | 🔴 3.1x slower |
...
| selectorFamily(id) | 🟢 1.4x faster | 🟢 2.4x faster |
| createStore | 🟢 10.1x faster | 🟢 7.9x faster |
| sub + unsub | 🟢 4.7x faster | 🟢 2.9x faster |
