...
|:----------|-----------:|-----------:|
| atom(1) | 🟢 20.4x faster | 🟢 2.0x faster |
| store.get(atom) | 🟢 9.3x faster | 🟢 13.7x faster |
| set(atom, value) | 🟢 12.1x faster | 🟢 4.5x faster |
| set(atom, curr => curr+1) | 🟢 12.5x faster | 🟢 5.0x faster |
| set(atom) with 10 subs | 🟢 18.5x faster | 🟢 5.1x faster |
| atom lifecycle (create+100get+100set) | 🟢 17.1x faster | 🟢 4.3x faster |
| set 1000 atoms | 🟢 15.5x faster | 🟢 5.0x faster |
| get 1000 atoms | 🟢 80.4x faster | 🟢 14.2x faster |

#### Selectors

| Benchmark | JSC (Safari) | V8 (Chrome) |
|:----------|-----------:|-----------:|
| selector(fn) | 🟢 11.1x faster | 🟢 1.2x faster |
| set + read 10 selectors | 🟢 3.4x faster | 🟢 2.2x faster |
| set + read 100 selectors | 🟢 4.0x faster | 🟢 1.6x faster |
...
| selectorFamily(id) | 🟢 1.4x faster | 🟡 1.1x slower |
| createStore | 🟢 11.2x faster | 🟢 8.6x faster |
| sub + unsub | 🟢 5.2x faster | 🟢 2.5x faster |
