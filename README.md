...
| set(atom, value) | 🟢 11.4x faster | 🟢 4.6x faster |
| set(atom, curr => curr+1) | 🟢 16.9x faster | 🟢 5.4x faster |
| set(atom) with 10 subs | 🟢 17.9x faster | 🟢 5.7x faster |
| atom lifecycle (create+100get+100set) | 🟢 15.7x faster | 🟢 4.4x faster |
| set 1000 atoms | 🟢 15.1x faster | 🟢 5.6x faster |
| get 1000 atoms | 🟢 77.3x faster | 🟢 14.2x faster |

#### Selectors

| Benchmark | JSC (Safari) | V8 (Chrome) |
|:----------|-----------:|-----------:|
| selector(fn) | 🟢 11.7x faster | 🟢 1.3x faster |
...
| txn: cross-atom 1000 selectors, set + read | 🟢 5.0x faster | 🟢 1.8x faster |
| txn: cross-atom 1000 selectors, with subs | 🟢 17.1x faster | 🟢 12.6x faster |
...
| sub + unsub | 🟢 4.8x faster | 🟢 2.6x faster |
