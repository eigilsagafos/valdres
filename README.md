...
|:----------|-----------:|-----------:|
| atom(1) | 🟢 15.9x faster | 🟢 1.8x faster |
| store.get(atom) | 🟢 13.8x faster | 🟢 14.9x faster |
| set(atom, value) | 🟢 13.4x faster | 🟢 5.2x faster |
| set(atom, curr => curr+1) | 🟢 13.8x faster | 🟢 5.5x faster |
| set(atom) with 10 subs | 🟢 19.0x faster | 🟢 6.3x faster |
| atom lifecycle (create+100get+100set) | 🟢 17.0x faster | 🟢 4.9x faster |
| set 1000 atoms | 🟢 16.8x faster | 🟢 5.3x faster |
| get 1000 atoms | 🟢 128.1x faster | 🟢 13.9x faster |
...
| set + read 10 selectors | 🟢 3.6x faster | 🟢 2.8x faster |
...
| txn: 10 atoms × 100 selectors, set + read | 🟢 4.3x faster | 🟢 2.1x faster |
| txn: cross-atom 1000 selectors, set + read | 🟢 5.2x faster | 🟢 2.0x faster |
| txn: cross-atom 1000 selectors, with subs | 🟢 16.9x faster | 🟢 12.8x faster |

#### Families

| Benchmark | JSC (Safari) | V8 (Chrome) |
|:----------|-----------:|-----------:|
| atomFamily(id) cache hit | 🔴 4.0x slower | 🔴 3.4x slower |
...
| createStore | 🟢 13.1x faster | 🟢 5.7x faster |
| sub + unsub | 🟢 5.4x faster | 🟢 2.7x faster |
