...
|:----------|-----------:|-----------:|
| atom(1) | 🟢 22.4x faster | 🟢 1.9x faster |
| store.get(atom) | 🟢 9.5x faster | 🟢 12.6x faster |
| set(atom, value) | 🟢 11.7x faster | 🟢 4.3x faster |
| set(atom, curr => curr+1) | 🟢 13.5x faster | 🟢 4.9x faster |
| set(atom) with 10 subs | 🟢 20.4x faster | 🟢 5.6x faster |
| atom lifecycle (create+100get+100set) | 🟢 18.6x faster | 🟢 4.5x faster |
| set 1000 atoms | 🟢 16.4x faster | 🟢 4.5x faster |
| get 1000 atoms | 🟢 76.3x faster | 🟢 15.0x faster |

#### Selectors

| Benchmark | JSC (Safari) | V8 (Chrome) |
|:----------|-----------:|-----------:|
| selector(fn) | 🟢 9.8x faster | 🟢 1.2x faster |
...
| Benchmark | JSC (Safari) | V8 (Chrome) |
|:----------|-----------:|-----------:|
| txn: 10 atoms × 10 selectors, set + read | 🟢 4.0x faster | 🟢 2.1x faster |
...
| txn: cross-atom 1000 selectors, with subs | 🟢 17.9x faster | 🟢 13.8x faster |

#### Families

| Benchmark | JSC (Safari) | V8 (Chrome) |
|:----------|-----------:|-----------:|
| atomFamily(id) cache hit | 🔴 4.8x slower | 🔴 3.4x slower |
...
| createStore | 🟢 10.2x faster | 🟢 8.9x faster |
| sub + unsub | 🟢 4.5x faster | 🟢 3.2x faster |

> [Full timing details](./BENCHMARKS.md) — Last updated: 2026-04-12 — [Historical trends](https://eigilsagafos.github.io/valdres/dev/bench/)
<!-- BENCH:END -->
