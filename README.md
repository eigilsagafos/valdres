...
|:----------|-----------:|-----------:|
| atom(1) | 🟢 9.4x faster | 🟢 1.7x faster |
| store.get(atom) | 🟢 27.6x faster | 🟢 7.2x faster |
| set(atom, value) | 🟢 15.4x faster | 🟢 3.1x faster |
| set(atom, curr => curr+1) | 🟢 15.7x faster | 🟢 5.4x faster |
| set(atom) with 10 subs | 🟢 13.8x faster | 🟢 3.8x faster |
| atom lifecycle (create+100get+100set) | 🟢 16.9x faster | 🟢 4.8x faster |
| set 1000 atoms | 🟢 9.0x faster | 🟢 5.4x faster |
| get 1000 atoms | 🟢 43.4x faster | 🟢 14.4x faster |
...
| set + read through 5 chained selectors | 🟢 2.1x faster | 🟢 1.8x faster |

#### Transactions

| Benchmark | JSC (Safari) | V8 (Chrome) |
|:----------|-----------:|-----------:|
| txn: 10 atoms × 10 selectors, set + read | 🟢 3.6x faster | 🟢 2.3x faster |
| txn: 10 atoms × 10 selectors, with subs | 🟢 4.2x faster | 🟢 3.0x faster |
| txn: 10 atoms × 100 selectors, set + read | 🟢 3.2x faster | 🟢 1.6x faster |
| txn: cross-atom 1000 selectors, set + read | 🟢 4.0x faster | 🟢 1.8x faster |
| txn: cross-atom 1000 selectors, with subs | 🟢 14.7x faster | 🟢 9.6x faster |
...
| createStore | 🟢 23.7x faster | 🟢 3.1x faster |
| sub + unsub | 🟢 3.1x faster | 🟢 1.9x faster |
