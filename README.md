...
|:----------|-----------:|-----------:|
| atom(1) | 🟢 13.8x faster | 🟢 2.5x faster |
| store.get(atom) | 🟢 13.2x faster | 🟢 14.2x faster |
| set(atom, value) | 🟢 12.9x faster | 🟢 5.3x faster |
| set(atom, curr => curr+1) | 🟢 14.2x faster | 🟢 5.7x faster |
| set(atom) with 10 subs | 🟢 19.2x faster | 🟢 6.5x faster |
| atom lifecycle (create+100get+100set) | 🟢 16.0x faster | 🟢 4.9x faster |
| set 1000 atoms | 🟢 15.6x faster | 🟢 5.4x faster |
| get 1000 atoms | 🟢 125.6x faster | 🟢 14.7x faster |
...
| set + read 10 selectors | 🟢 3.6x faster | 🟢 2.6x faster |
...
| txn: 10 atoms × 100 selectors, set + read | 🟢 4.5x faster | 🟢 1.8x faster |
| txn: cross-atom 1000 selectors, set + read | 🟢 5.1x faster | 🟢 2.1x faster |
| txn: cross-atom 1000 selectors, with subs | 🟢 17.5x faster | 🟢 12.2x faster |

#### Families

| Benchmark | JSC (Safari) | V8 (Chrome) |
|:----------|-----------:|-----------:|
| atomFamily(id) cache hit | 🔴 2.5x slower | 🔴 3.4x slower |
...
| selectorFamily(id) | 🟢 1.3x faster | 🟢 1.6x faster |
| createStore | 🟢 13.4x faster | 🟢 6.0x faster |
| sub + unsub | 🟢 5.5x faster | 🟢 2.6x faster |
