...
| set(atom, curr => curr+1) | 🟢 14.0x faster | 🟢 4.8x faster |
| set(atom) with 10 subs | 🟢 17.6x faster | 🟢 5.4x faster |
| atom lifecycle (create+100get+100set) | 🟢 16.9x faster | 🟢 4.3x faster |
| set 1000 atoms | 🟢 15.3x faster | 🟢 4.9x faster |
| get 1000 atoms | 🟢 52.7x faster | 🟢 14.1x faster |
...
| txn: cross-atom 1000 selectors, with subs | 🟢 18.0x faster | 🟢 12.3x faster |

#### Families

| Benchmark | JSC (Safari) | V8 (Chrome) |
|:----------|-----------:|-----------:|
| atomFamily(id) cache hit | 🔴 2.6x slower | 🔴 4.2x slower |
...
| createStore | 🟢 10.8x faster | 🟢 8.0x faster |
| sub + unsub | 🟢 4.9x faster | 🟢 2.8x faster |
