...
|:----------|-----------:|-----------:|
| atom(1) | 🟢 19.7x faster | 🟢 2.0x faster |
| store.get(atom) | 🟢 9.0x faster | 🟢 13.9x faster |
| set(atom, value) | 🟢 12.4x faster | 🟢 4.4x faster |
| set(atom, curr => curr+1) | 🟢 15.1x faster | 🟢 5.0x faster |
| set(atom) with 10 subs | 🟢 18.3x faster | 🟢 5.4x faster |
| atom lifecycle (create+100get+100set) | 🟢 17.6x faster | 🟢 4.4x faster |
| set 1000 atoms | 🟢 15.7x faster | 🟢 5.2x faster |
| get 1000 atoms | 🟢 51.5x faster | 🟢 14.7x faster |

#### Selectors

| Benchmark | JSC (Safari) | V8 (Chrome) |
|:----------|-----------:|-----------:|
| selector(fn) | 🟢 10.9x faster | 🟢 1.2x faster |
...
| txn: cross-atom 1000 selectors, with subs | 🟢 16.9x faster | 🟢 13.0x faster |

#### Families

| Benchmark | JSC (Safari) | V8 (Chrome) |
|:----------|-----------:|-----------:|
| atomFamily(id) cache hit | 🔴 2.7x slower | 🔴 4.2x slower |
...
| selectorFamily(id) | 🟢 1.3x faster | 🟢 1.8x faster |
| createStore | 🟢 11.3x faster | 🟢 7.7x faster |
