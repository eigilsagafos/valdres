...
| store.get(atom) | 🟢 9.5x faster | 🟢 11.8x faster |
| set(atom, value) | 🟢 11.6x faster | 🟢 4.7x faster |
| set(atom, curr => curr+1) | 🟢 17.9x faster | 🟢 5.9x faster |
| set(atom) with 10 subs | 🟢 19.6x faster | 🟢 5.6x faster |
| atom lifecycle (create+100get+100set) | 🟢 16.6x faster | 🟢 4.4x faster |
| set 1000 atoms | 🟢 16.6x faster | 🟢 5.2x faster |
| get 1000 atoms | 🟢 50.6x faster | 🟢 14.2x faster |
...
| Benchmark | JSC (Safari) | V8 (Chrome) |
|:----------|-----------:|-----------:|
| txn: 10 atoms × 10 selectors, set + read | 🟢 5.0x faster | 🟢 1.9x faster |
| txn: 10 atoms × 10 selectors, with subs | 🟢 5.0x faster | 🟢 3.4x faster |
| txn: 10 atoms × 100 selectors, set + read | 🟢 6.0x faster | 🟢 1.7x faster |
| txn: cross-atom 1000 selectors, set + read | 🟢 5.4x faster | 🟢 1.9x faster |
| txn: cross-atom 1000 selectors, with subs | 🟢 18.3x faster | 🟢 13.8x faster |
...
| createStore | 🟢 9.8x faster | 🟢 7.8x faster |
