...
cycle-search visits by host and call site, aggregate negative-proof memo
admission/probe/prune counters, transient selector-host counts, and
...
recorded. Labels are metadata, not identity. The core inspection schema is
version 3.
