...
That's it. Your existing Recoil code will work with Valdres under the hood. You get Valdres performance without any code changes.

<div className="callout callout-tip">
  <div className="callout-title">Why migrate from Recoil?</div>
  Recoil is no longer actively maintained. Valdres is actively developed, has a smaller bundle size, and doesn't require string keys for atoms.
</div>
