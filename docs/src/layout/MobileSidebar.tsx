...
export function MobileSidebar({ nav, currentRoute, framework }: Props) {
    ...
    return (
        <div
            id="mobile-sidebar"
            className="hidden fixed inset-0 z-[90] lg:hidden"
        >
            <div id="mobile-sidebar-backdrop" className="absolute inset-0 bg-black/50" />
            <aside className="relative w-72 h-full bg-surface-raised dark:bg-surface-sunken-dark border-r border-border dark:border-border-dark overflow-y-auto">
                ...
                <nav className="px-3 pb-6">
                    ...
                    {/* Framework selector */}
                    <div className="mb-5">
                        <div className="relative" id="mobile-fw-selector">
                            <button
                                id="mobile-fw-trigger"
                            ...
                            <div id="mobile-fw-menu" className="hidden absolute left-0 right-0 top-full mt-1 rounded-lg border border-border dark:border-border-dark bg-surface dark:bg-surface-raised-dark shadow-lg z-50 py-1 overflow-hidden">
                                {frameworkList.filter(f => f !== "vanilla").map(fw => (
                                    <button
                                        key={fw}
                                        data-fw={fw}
