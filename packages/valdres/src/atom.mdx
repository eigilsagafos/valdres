...
In development and tests, Valdres deep-freezes plain object and array atom
values so accidental in-place changes fail immediately. Error objects and
Promise handles remain usable while their object surface is frozen. Production
builds skip this development check.
