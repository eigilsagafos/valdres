// Reactive/currentness-only build observation. This is bundled ONLY in the counter artifact.
...
export const observer = {
    ...
    reset({ trace = true } = {}) {
        ...
        records = new Map()
        events = []
        reactiveCounts = Object.fromEntries(
            [
                "closureNodes",
                "invalidationPops",
                "uncertaintyTransitions",
                "currentHits",
                "settlementChecks",
                "cleanBranchSkips",
            ].map(k => [k, 0]),
    ...
    snapshot() {
        return structuredClone({
            common: counts,
            candidateSpecific: reactiveCounts,
