...
import { reducedTransparencyAtom, prefersReducedTransparencySelector } from "../../src/index"
...
assert.equal(app.get(reducedTransparencyAtom), "no-preference")
assert.equal(app.get(prefersReducedTransparencySelector), false)
